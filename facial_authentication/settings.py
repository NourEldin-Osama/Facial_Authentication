"""
Django settings for facial_authentication project.
...
SECRET_KEY = 'django-insecure-!@8yk21t$b@xh=b-j%x2-u@p5(@cj3=t7+#%+y$56e7oy%prvi'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
                  ...
                  'apps.facial_authentication_app.apps.FacialAuthenticationAppConfig', 'rest_framework', "corsheaders",
                  'sslserver', ]
...
ROOT_URLCONF = 'facial_authentication.urls'
...
WSGI_APPLICATION = 'facial_authentication.wsgi.application'
...
STATIC_URL = 'static/'
MEDIA_URL = '/media/'
MEDIA_ROOT = Path(BASE_DIR / 'facial_authentication/media/')
